...
Summary statistics of international stock indexes.
...
From the ACF and PACF tables, we can see that there are some indicators of autocorrelation in the indexes.
